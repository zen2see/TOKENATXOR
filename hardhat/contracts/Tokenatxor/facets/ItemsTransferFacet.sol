...
import {Modifiers, EQUIPPED_SLOTS, Tokenatxor} from "../libraries/LibAppStorage.sol";
...
contract ItemsTransferFacet is Modifiers {
    ...
    function transferFromTokenApproved(
        ...
        if (_fromContract == address(this)) {
            address owner = s.tokenatxors[_fromTokenId].owner;
            require(
            ...
            require(s.tokenatxors[_fromTokenId].locked == false, "ItemsTransfer: Only callable on unlocked Tokenatxors");
        } else {
    ...
    function extractItemsFromSacrificedTokenatxor(
        address _to,
        uint256 _tokenId,
        ...
        require(tokenatxor.owner == address(0), "Tokenatxor has not been sacrificed");
