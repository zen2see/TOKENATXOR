...
library LibSvg {
    ...
    // svg type: "tokenatxorSvgs"
    uint256 internal constant CLOSED_PRODUCTION_SVG_ID = 0;
    uint256 internal constant OPEN_PRODUCTION_SVG_ID = 1;
    uint256 internal constant TOKENATXOR_BODY_SVG_ID = 2;
