...
export interface ItemTypeInput {
  ...
  tktrPrice: BigNumberish | BigNumberish;
  traitModifiers: [
    BigNumberish,
    BigNumberish,
    BigNumberish,
...
export function getItemTypes(itemTypes: ItemTypeInputNew[]): ItemTypeOutput[] {
  ...
  for (const itemType of itemTypes) {
    ...
    let itemTypeOut: ItemTypeOutput = {
      ...
      tktrPrice: rarityLevelToTktrPrice(itemType.rarityLevel),
...
function rarityLevelToTktrPrice(rarityLevel: rarityLevel): BigNumberish {
  switch (rarityLevel) {
    case "common":
      return "5";
    case "uncommon":
