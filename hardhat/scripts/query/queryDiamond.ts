...
async function main () {
  ...
  let events = Array()
  let diamond
  diamond = await ethers.getContractAt('ERC721MarketplaceFacet', tokenatxorDiamondAddress)
  let filter
  ...
  let diamond3
  let listingId
  diamond3 = await ethers.getContractAt('LibERC721Marketplace', tokenatxorDiamondAddress)
  listingId = 81123
  ...
  let diamond2
  diamond2 = await ethers.getContractAt('contracts/tokenatxor/facets/ItemsFacet.sol:ItemsFacet', tokenatxorDiamondAddress)
  ...
  diamond2 = await ethers.getContractAt('LibERC1155', tokenatxorDiamondAddress)
  ...
  // diamond = await ethers.getContractAt('contracts/tokenatxor/facets/tokenatxorFacet.sol:tokenatxorFacet', tokenatxorDiamondAddress)
  // const result = await diamond.gettokenatxor(7401)
  // console.log(result)

  // const erc1155Marketplace = await ethers.getContractAt('ERC1155MarketplaceFacet', tokenatxorDiamondAddress)
  // const itemsFacet = await ethers.getContractAt('contracts/tokenatxor/facets/ItemsFacet.sol:ItemsFacet', tokenatxorDiamondAddress)
  ...
  // diamond = await ethers.getContractAt('ERC1155MarketplaceFacet', tokenatxorDiamondAddress)
  // let filter
  ...
  // diamond = await ethers.getContractAt('contracts/tokenatxor/facets/ItemsFacet.sol:ItemsFacet', tokenatxorDiamondAddress)
  ...
  //     console.log(i)
  //   }
  //   const result = await diamond.gettokenatxorListing(i)
  //   if (result.listing_.cancelled === true || !result.listing_.timePurchased.eq(0)) {
  //     continue
  //   } else {
  //     if (result.listing_.seller !== result.tokenatxorInfo_.owner) {
  //       console.log('Listing ID:', result.listing_.listingId.toString(), ' | TokenId:', result.listing_.erc721TokenId.toString())
  //     }
  //   }
  // }

  // const result = await diamond.gettokenatxorListing(2038)
  // console.log(result)

  // console.log(result)

  // diamond = await ethers.getContractAt('contracts/tokenatxor/facets/tokenatxorFacet.sol:tokenatxorFacet', tokenatxorDiamondAddress)
  // const result = await diamond.gettokenatxor(805)

  // console.log(result)

  // const diamond = await ethers.getContractAt('tokenatxorGameFacet', tokenatxorDiamondAddress)
  // const filter = diamond.filters.SettokenatxorName()
  ...
  // const value = await diamond.tokenatxorNameAvailable('CASPER THE FRIENDLY GHOST')
  // console.log(value)

  // let diamond = await ethers.getContractAt('VrfFacet', tokenatxorDiamondAddress)
  // const tx = await diamond.drawRandomNumber(3323)
  // await tx.wait()

  // diamond = await ethers.getContractAt('contracts/tokenatxor/facets/tokenatxorFacet.sol:tokenatxorFacet', tokenatxorDiamondAddress)
  // const g = await diamond.gettokenatxor(3323)
  // console.log(g)
  // 2575
  // const tokenId = ethers.BigNumber.from('2575')
  // const erc721Marketplace = await ethers.getContractAt('ERC721MarketplaceFacet', tokenatxorDiamondAddress)
