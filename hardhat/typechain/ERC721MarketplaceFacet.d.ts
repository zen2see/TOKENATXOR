...
interface ERC721MarketplaceFacetInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getOwnerTokenatxorListings(address,uint256,string,uint256)": FunctionFragment;
    "getTokenatxorListing(uint256)": FunctionFragment;
    "getTokenatxorListings(uint256,string,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getOwnerTokenatxorListings",
    values: [string, BigNumberish, string, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "getTokenatxorListing",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "getTokenatxorListings",
    values: [BigNumberish, string, BigNumberish]
  ): string;
  encodeFunctionData(
