...
interface BridgeFacetInterface extends ethers.utils.Interface {
  functions: {
    ...
    "withdrawTokenatxorBatch(uint256[])": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "withdrawTokenatxorBatch",
    values: [BigNumberish[]]
  ): string;
  ...
  events: {
    ...
    "AddedTokenatxorBatch(address,uint256[])": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "AddedTokenatxorBatch"): EventFragment;
...
export type AddedTokenatxorBatchEvent = TypedEvent<
...
export class BridgeFacet extends BaseContract {
  ...
  filters: {
    ...
    "AddedTokenatxorBatch(address,uint256[])"(
      owner?: string | null,
      tokenIds?: null
    ): TypedEventFilter<
      [string, BigNumber[]],
