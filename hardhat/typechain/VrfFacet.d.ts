...
interface VrfFacetInterface extends ethers.utils.Interface {
  functions: {
    ...
    "openProducions(uint256[])": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "openProducions",
    values: [BigNumberish[]]
  ): string;
  encodeFunctionData(
  ...
  events: {
    "OpenProductions(uint256[])": EventFragment;
    "ProductionOpened(uint256)": EventFragment;
    "VrfRandomNumber(uint256,uint256,uint256)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "OpenProductions"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "ProductionOpened"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "VrfRandomNumber"): EventFragment;
}

export type OpenProductionsEvent = TypedEvent<
  [BigNumber[]] & { _tokenIds: BigNumber[] }
>;

export type ProductionOpenedEvent = TypedEvent<
