...
interface SvgFacetInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getTokenatxorSvg(uint256)": FunctionFragment;
    "previewTokenatxor(uint256,address,int16[6],uint16[16])": FunctionFragment;
    "productionlTokenatxorsSvg(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getTokenatxorSvg",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "previewTokenatxor",
    values: [
      BigNumberish,
      string,
      [
  ...
  encodeFunctionData(
    functionFragment: "productionlTokenatxorsSvg",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [{ sleeveId: BigNumberish; equippableId: BigNumberish }[]]
  ): string;
  encodeFunctionData(
...
export class SvgFacet extends BaseContract {
  ...
  functions: {
    ...
    setSleeves(
      _sleeves: { sleeveId: BigNumberish; equippableId: BigNumberish }[],
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
